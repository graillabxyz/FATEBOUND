...
Dice are code-rendered physical meshes, not generated art: tetrahedron, cube, octahedron, pentagonal trapezohedron, dodecahedron and icosahedron. Their geometry is purely presentational; production face definitions and opposite mappings remain authoritative.
...
Asset type: portrait mobile game environment background for a folklore competitive dice/card game, Fatebound
...
Constraints: Generate only the background artwork. No characters, dice, cards, text, letters, UI, logos, watermark, or literal culturally specific writing.
...
Constraints: No large cracks, no repeating motifs, no objects, no text, no symbols, no borders, no logos or watermark.
